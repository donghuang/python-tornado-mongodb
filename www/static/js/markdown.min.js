! function(a) {
    ...
    var e = b.isArray = Array.isArray || function(a) {
        return "[object Array]" === Object.prototype.toString.call(a)
    };
    b.forEach = Array.prototype.forEach ? function(a, b, c) {
    ...
    f.renderJsonML = function(a, b) {
        ...
        if (b.root) c.push(k(a));
            ...
            for (a.shift(), !a.length || "object" != typeof a[0] || a[0] instanceof Array || a.shift(); a.length;) c.push(k(a.shift()));
        return c.join("\n\n")
        ...
        r = {
            ...
            inline: {
                ...
                "[": function Q(a) {
                    ...
                    if (g) {
                        var h = g[1];
                        if (d += g[0].length, h && "<" === h[0] && ">" === h[h.length - 1] && (h = h.substring(1, h.length - 1)), !g[3])
    ...
    t.processMetaHash = function(a) {
        for (var b = u(a), c = {}, d = 0; d < b.length; ++d)
